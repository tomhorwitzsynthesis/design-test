...
for company, filename in keys_data.items():
    ...
    if os.path.exists(file_path):
        df_agility = pd.read_excel(file_path, sheet_name="Raw Data")
...
st.subheader("📊 Media Mentions Volume Trend")
